...
class ResNetSE(nn.Module):
    def __init__(self, block, layers, num_filters, embedding_dim, encoder_type='SAP', n_mels=40, log_input=True, is_mel=True,  **kwargs):
...
def MainModel(embedding_dim=512, **kwargs):
    # Number of filters
