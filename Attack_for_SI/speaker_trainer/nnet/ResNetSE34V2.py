...
class ResNetSE(nn.Module):
    def __init__(self, block, layers, num_filters, n_mels=40, log_input=True, is_mel=True, **kwargs):
        super(ResNetSE, self).__init__()

        print('Embedding size is %d, encoder %s.'%(kwargs['embedding_dim'], kwargs['pooling_type']))
        self.is_mel = is_mel
        ...
        self.fc = nn.Linear(out_dim, self.embedding_dim)
